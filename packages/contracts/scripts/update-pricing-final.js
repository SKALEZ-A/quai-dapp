...
async function main() {
  try {
    console.log('\n═══════════════════════════════════════════════════════')
    console.log('💰 UPDATING QNS PRICING - FINAL AFFORDABLE PRICING')
    console.log('   (5/20/50 QUAI - Much cheaper for testnet users)')
    console.log('═══════════════════════════════════════════════════════\n')
    ...
    // AFFORDABLE pricing in QUAI units (much cheaper than current)
    const newPricing = {
      3: '50000000000000000000',  // 50 QUAI (was 1000 QUAI)
      4: '20000000000000000000',  // 20 QUAI (was 500 QUAI)  
      5: '5000000000000000000',   // 5 QUAI (was 200 QUAI)
      6: '5000000000000000000',   // 5 QUAI (was 200 QUAI)
      7: '5000000000000000000',   // 5 QUAI (was 200 QUAI)
    }
    
    console.log('💰 AFFORDABLE PRICING (QUAI units):')
    console.log('   3-char domains: 50 QUAI (was 1000 QUAI) - 20x cheaper!')
    console.log('   4-char domains: 20 QUAI (was 500 QUAI) - 25x cheaper!')
    console.log('   5-char domains: 5 QUAI (was 200 QUAI) - 40x cheaper!')
    console.log('   6-char domains: 5 QUAI (was 200 QUAI) - 40x cheaper!')
    console.log('   7-char domains: 5 QUAI (was 200 QUAI) - 40x cheaper!\n')
    ...
    console.log('═══════════════════════════════════════════════════════')
    console.log('✅ 3 chars: 50 QUAI (was 1000 QUAI) - 20x cheaper!')
    console.log('✅ 4 chars: 20 QUAI (was 500 QUAI) - 25x cheaper!')
    console.log('✅ 5+ chars: 5 QUAI (was 200 QUAI) - 40x cheaper!')
