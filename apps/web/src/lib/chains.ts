...
export const DEFAULT_CHAINS: QuaiChains = {
  ...
  testnet: {
    cyprus1: { name: "Orchard Cyprus-1", chainId: 9000, rpcHttpUrl: "https://orchard.rpc.quai.network/cyprus1", rpcWsUrl: "wss://orchard.rpc.quai.network/cyprus1", currencySymbol: "tQUAI" },
    cyprus2: { name: "Orchard Cyprus-2", chainId: 9000, rpcHttpUrl: "https://orchard.rpc.quai.network/cyprus2", rpcWsUrl: "wss://orchard.rpc.quai.network/cyprus2", currencySymbol: "tQUAI" },
    cyprus3: { name: "Orchard Cyprus-3", chainId: 9000, rpcHttpUrl: "https://orchard.rpc.quai.network/cyprus3", rpcWsUrl: "wss://orchard.rpc.quai.network/cyprus3", currencySymbol: "tQUAI" },
    paxos1: { name: "Orchard Paxos-1", chainId: 9000, rpcHttpUrl: "https://orchard.rpc.quai.network/paxos1", rpcWsUrl: "wss://orchard.rpc.quai.network/paxos1", currencySymbol: "tQUAI" },
    paxos2: { name: "Orchard Paxos-2", chainId: 9000, rpcHttpUrl: "https://orchard.rpc.quai.network/paxos2", rpcWsUrl: "wss://orchard.rpc.quai.network/paxos2", currencySymbol: "tQUAI" },
    paxos3: { name: "Orchard Paxos-3", chainId: 9000, rpcHttpUrl: "https://orchard.rpc.quai.network/paxos3", rpcWsUrl: "wss://orchard.rpc.quai.network/paxos3", currencySymbol: "tQUAI" },
    hydrus1: { name: "Orchard Hydrus-1", chainId: 9000, rpcHttpUrl: "https://orchard.rpc.quai.network/hydrus1", rpcWsUrl: "wss://orchard.rpc.quai.network/hydrus1", currencySymbol: "tQUAI" },
    hydrus2: { name: "Orchard Hydrus-2", chainId: 9000, rpcHttpUrl: "https://orchard.rpc.quai.network/hydrus2", rpcWsUrl: "wss://orchard.rpc.quai.network/hydrus2", currencySymbol: "tQUAI" },
    hydrus3: { name: "Orchard Hydrus-3", chainId: 9000, rpcHttpUrl: "https://orchard.rpc.quai.network/hydrus3", rpcWsUrl: "wss://orchard.rpc.quai.network/hydrus3", currencySymbol: "tQUAI" },
  },
};
